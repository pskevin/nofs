...
ACLOCAL = ${SHELL} /u/pskevin/git/nofs/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /u/pskevin/git/nofs/missing autoconf
AUTOHEADER = ${SHELL} /u/pskevin/git/nofs/missing autoheader
AUTOMAKE = ${SHELL} /u/pskevin/git/nofs/missing automake-1.15
AWK = gawk
CC = gcc
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /u/pskevin/git/nofs/missing makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
...
STRIP = 
VERSION = 2018-02-04
abs_builddir = /u/pskevin/git/nofs
abs_srcdir = /u/pskevin/git/nofs
abs_top_builddir = /u/pskevin/git/nofs
abs_top_srcdir = /u/pskevin/git/nofs
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /u/pskevin/git/nofs/install-sh
